...
//      System.out.println("***** ******* "+value);
    ...
    @Then("User compares {string} in by response with {string} in ByCityID response")
    public void userComparesInByResponseWithInByCityIDResponse(String arg0, String arg1) {
    }
}