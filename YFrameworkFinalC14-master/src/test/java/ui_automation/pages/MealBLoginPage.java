...
public class MealBLoginPage {
    private static final Logger LOGGER = LogManager.getLogger(MealBLoginPage.class);

    public MealBLoginPage() {
        PageFactory.initElements(Driver.getInstance().getDriver(), this);
        LOGGER.info("MealBLoginPage is initialized.");
    }

    @FindBy(css = "[name=usernameOrEmailAddress]")
